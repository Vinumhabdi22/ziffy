...
export default function FactsAndFeatures({ listing }: FactsAndFeaturesProps) {
    ...
    // External Link (Using map_url or fallback as per requirements implicit suggestion of external link)
    // Requirement says: "URL stored in Supabase and fetched dynamically"
    // I'll assume it's `listing.map_url` or a specific field. If not, I'll use a placeholder.
    const externalLink = listing.map_url || "#";
    ...
    return (
        <div className="bg-white rounded-xl border border-warm-gray-200 overflow-hidden shadow-sm mb-6">
            ...
            <div className="p-6">
                ...
                {/* Disclaimer & External Link Section */}
                <div className="bg-blue-50 border border-blue-100 rounded-lg p-5 flex flex-col items-center text-center">
                    ...
                    <a
                        ...
                        className="bg-primary hover:bg-primary/90 text-white font-bold py-2 px-6 rounded-lg transition-colors flex items-center gap-2"
                    >
